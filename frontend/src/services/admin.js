...
export const renameUserProfile = (id, username) => client.patch(`/api/admin/users/${id}/profile`, { username })
export const reorderUsers = (order) => client.post('/api/admin/users/reorder', { order })
export const topAdminExists = () => client.get('/api/admin/top-admin').then(r => r.data)
